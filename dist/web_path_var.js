...
const Config = {
  server: {
    userConfigApiUrl: "https://dev.config.realty-ai.com/dev/user_config_api" 
  },
  bot: {
    defaultAvatarSrc: "https://cdn.realty-ai.com/chat/images/default_avatar.png",
    socketTimeout: 60000
  },
  theme: {
    messages: {
...
const _tmpl$$d = /*#__PURE__*/template(`<div aria-hidden="true">`),
  _tmpl$2$8 = /*#__PURE__*/template(`<figure aria-hidden="true" role="presentation"><img alt="Bot avatar" loading="lazy" decoding="async" role="presentation" aria-hidden="true" class="rounded-full object-cover w-full h-full">`);
const Avatar = props => {
  return (() => {
    const _el$ = _tmpl$2$8(),
    ...
    insert(_el$, createComponent(Show, {
      ...
      get children() {
        ...
        createRenderEffect(_p$ => {
          const _v$ = `live-dot ${props.animate ? "live-dot-animate" : ""}`,
            _v$2 = props.liveIconPosition === "right" ? "84%" : "16%";
          _v$ !== _p$._v$ && className(_el$3, _p$._v$ = _v$);
          _v$2 !== _p$._v$2 && ((_p$._v$2 = _v$2) != null ? _el$3.style.setProperty("left", _v$2) : _el$3.style.removeProperty("left"));
          return _p$;
        }, {
          _v$: undefined,
          _v$2: undefined
    ...
    createRenderEffect(_p$ => {
      const _v$3 = "flex justify-center items-center rounded-full text-white relative flex-shrink-0 " + (props.class || "") + (isMobileCheck() ? "w-8 h-8 text-sm" : "w-10 h-10 text-xl"),
        ...
        _v$5 = props.src || Config.bot.defaultAvatarSrc;
      _v$3 !== _p$._v$3 && className(_el$, _p$._v$3 = _v$3);
      _p$._v$4 = style(_el$, _v$4, _p$._v$4);
      _v$5 !== _p$._v$5 && setAttribute(_el$2, "src", _p$._v$5 = _v$5);
      return _p$;
    }, {
      _v$3: undefined,
      _v$4: undefined,
...
const _tmpl$$c = /*#__PURE__*/template(`<div class="fixed items-end"><div class="w-60 h-32 flex justify-end items-end"><div class="px-4 py-2 ml-2 whitespace-pre-wrap max-w-full chatbot-host-bubble chatbot-welcome-message relative" aria-live="polite"><button class="absolute top-[-6px] right-[-6px] h-5 w-5 flex justify-center items-center cursor-pointer hover:scale-125 active:scale-90 transition-transform duration-100"><span style="font-size:11pt">&cross;`),
  _tmpl$2$7 = /*#__PURE__*/template(`<svg viewBox="0 0 24 24"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z">`),
  ...
  _tmpl$4$1 = /*#__PURE__*/template(`<svg viewBox="0 0 24 24" aria-hidden="true" role="presentation"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z">`),
  _tmpl$5$1 = /*#__PURE__*/template(`<img loading="lazy" decoding="async" role="presentation" aria-hidden="true" alt="Bubble button icon">`),
  _tmpl$6$1 = /*#__PURE__*/template(`<div class="live-dot live-dot-animate" role="presentation" aria-hidden="true">`);
...
const BubbleButton = props => {
  ...
  const openPopout = () => {
    ...
    setPopoutShown(true);
    setPopoutMessage(props.popoutMessageTheme.message ? props.popoutMessageTheme.message[Math.floor(Math.random() * props.popoutMessageTheme.message.length)] : "");
  };
  const closePopout = () => {
  ...
  return (() => {
    ...
    insert(_el$, createComponent(Show, {
      get when() {
        return createMemo(() => !!(!props.isBotOpened && popoutShown()))() && !popoutClosed();
      },
      get children() {
        const _el$2 = _tmpl$$c(),
        ...
        insert(_el$4, popoutMessage, _el$5);
        _el$5.$$click = closePopout;
        _el$5.style.setProperty("z-index", "42424244");
        _el$5.style.setProperty("border-radius", "50%");
        createRenderEffect(_p$ => {
          const _v$ = props.position === "right" ? `${(props.xOffset ? props.xOffset : defaultRight) + (props.size === "large" ? 58 : 48)}px` : undefined,
            _v$2 = props.position === "left" ? `${props.xOffset ? props.xOffset : defaultRight}px` : undefined,
            _v$3 = `${(props.bottom ? props.bottom : defaultBottom) + (props.size === "large" ? 58 : 48)}px`,
            _v$4 = props.popoutMessageTheme.backgroundColor ?? Config.theme.messages.bot.defaultBackgroundColor,
            _v$5 = getContrastingColor(props.popoutMessageTheme.backgroundColor ?? Config.theme.messages.bot.defaultBackgroundColor),
            _v$6 = getContrastingColor(props.popoutMessageTheme.backgroundColor ?? Config.theme.messages.bot.defaultBackgroundColor),
            _v$7 = props.popoutMessageTheme.backgroundColor ?? Config.theme.messages.bot.defaultBackgroundColor;
          ...
          _v$3 !== _p$._v$3 && ((_p$._v$3 = _v$3) != null ? _el$2.style.setProperty("bottom", _v$3) : _el$2.style.removeProperty("bottom"));
          _v$4 !== _p$._v$4 && ((_p$._v$4 = _v$4) != null ? _el$4.style.setProperty("background-color", _v$4) : _el$4.style.removeProperty("background-color"));
          ...
          _v$7 !== _p$._v$7 && ((_p$._v$7 = _v$7) != null ? _el$5.style.setProperty("color", _v$7) : _el$5.style.removeProperty("color"));
          return _p$;
        }, {
          _v$: undefined,
          _v$2: undefined,
    ...
    insert(_el$6, createComponent(Show, {
      ...
      keyed: true,
      get children() {
        const _el$7 = _tmpl$2$7();
        createRenderEffect(_p$ => {
          const _v$8 = props.iconColor ?? defaultIconColor,
            _v$9 = `stroke-2 fill-transparent absolute duration-200 transition ` + (props.isBotOpened ? "scale-0 opacity-0" : "scale-100 opacity-100") + (props.size === "large" ? " w-11" : " w-9");
          _v$8 !== _p$._v$8 && ((_p$._v$8 = _v$8) != null ? _el$7.style.setProperty("stroke", _v$8) : _el$7.style.removeProperty("stroke"));
          _v$9 !== _p$._v$9 && setAttribute(_el$7, "class", _p$._v$9 = _v$9);
          return _p$;
        }, {
          _v$8: undefined,
          _v$9: undefined
        ...
        return createComponent(Show, {
          ...
          get fallback() {
            return [createComponent(Show, {
              ...
              get children() {
                ...
                createRenderEffect(_p$ => {
                  const _v$17 = props.iconColor ?? defaultIconColor,
                    _v$18 = `stroke-2 fill-transparent absolute duration-200 transition ` + (props.isBotOpened ? "scale-0 opacity-0" : "scale-100 opacity-100") + (props.size === "large" ? " w-11 h-11" : " w-9 h-9");
                  _v$17 !== _p$._v$17 && ((_p$._v$17 = _v$17) != null ? _el$9.style.setProperty("stroke", _v$17) : _el$9.style.removeProperty("stroke"));
                  _v$18 !== _p$._v$18 && setAttribute(_el$9, "class", _p$._v$18 = _v$18);
                  return _p$;
                }, {
                  _v$17: undefined,
                  _v$18: undefined
              ...
              get children() {
                ...
                createRenderEffect(_p$ => {
                  const _v$19 = props.customIconSrc,
                    _v$20 = "rounded-full object-cover" + (props.isBotOpened ? "scale-0 opacity-0" : "scale-100 opacity-100") + (props.size === "large" ? " w-11 h-11" : " w-9 h-9");
                  _v$19 !== _p$._v$19 && setAttribute(_el$10, "src", _p$._v$19 = _v$19);
                  _v$20 !== _p$._v$20 && className(_el$10, _p$._v$20 = _v$20);
                  return _p$;
                }, {
                  _v$19: undefined,
                  _v$20: undefined
          ...
          get children() {
            return createComponent(Avatar, {
              ...
              isLive: true,
              animate: true,
              get liveIconPosition() {
                return props.liveIconPosition;
              }
            });
          }
        });
    ...
    createRenderEffect(_p$ => {
      const _v$10 = `fixed shadow-md rounded-full hover:scale-110 active:scale-95 transition-transform duration-200 flex justify-center items-center animate-fade-in` + (props.size === "large" ? " w-20 h-20" : " w-16 h-16"),
        _v$11 = props.backgroundColor ?? defaultButtonColor$1,
        _v$12 = props.position === "right" ? props.xOffset ? `${props.xOffset.toString()}px` : `${defaultRight}px` : undefined,
        _v$13 = props.position === "left" ? props.xOffset ? `${props.xOffset.toString()}px` : `${defaultRight}px` : undefined,
        _v$14 = props.bottom ? `${props.bottom.toString()}px` : `${defaultBottom}px`,
        _v$15 = props.iconColor ?? "white",
        _v$16 = `absolute duration-200 transition ` + (props.isBotOpened ? "scale-100 rotate-0 opacity-100" : "scale-0 -rotate-180 opacity-0") + (props.size === "large" ? " w-11" : " w-9");
      _v$10 !== _p$._v$10 && className(_el$6, _p$._v$10 = _v$10);
      _v$11 !== _p$._v$11 && ((_p$._v$11 = _v$11) != null ? _el$6.style.setProperty("background-color", _v$11) : _el$6.style.removeProperty("background-color"));
      _v$12 !== _p$._v$12 && ((_p$._v$12 = _v$12) != null ? _el$6.style.setProperty("right", _v$12) : _el$6.style.removeProperty("right"));
      _v$13 !== _p$._v$13 && ((_p$._v$13 = _v$13) != null ? _el$6.style.setProperty("left", _v$13) : _el$6.style.removeProperty("left"));
      _v$14 !== _p$._v$14 && ((_p$._v$14 = _v$14) != null ? _el$6.style.setProperty("bottom", _v$14) : _el$6.style.removeProperty("bottom"));
      _v$15 !== _p$._v$15 && ((_p$._v$15 = _v$15) != null ? _el$8.style.setProperty("fill", _v$15) : _el$8.style.removeProperty("fill"));
      _v$16 !== _p$._v$16 && setAttribute(_el$8, "class", _p$._v$16 = _v$16);
      return _p$;
    }, {
      _v$10: undefined,
      _v$11: undefined,
...
(function (MessageType) {
  MessageType["BotMessage"] = "apiMessage";
...
const getExpectedMessageTime = message => {
  switch (message.type) {
    case MessageType.UserMessage:
      return 0;
    case MessageType.BotMessage:
      return Math.max(Math.min(message.message.length * BOT_MESSAGE_TIME_PER_CHARACTER, BOT_MESSAGE_MAX_TIME), BOT_MESSAGE_MIN_TIME);
    default:
      return 0;
  }
};
const sendMessageQuery = ({
  ...
  return new Promise((resolve, reject) => {
    ...
    sendRequest({
      ...
      const messages = res.data.messages.reduce((acc, message, index) => {
        const expectedMessageTime = Math.max(getExpectedMessageTime(message) - (index === 0 ? responseTime - startTime : 0), 0);
...
//       return false;
//     });
const checkChatEngineHeartbeat = apiHost => Promise.resolve(true);
...
const _tmpl$$a = /*#__PURE__*/template(`<button type="submit">`),
  _tmpl$2$6 = /*#__PURE__*/template(`<svg><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle><path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z">`);
...
const _tmpl$$9 = /*#__PURE__*/template(`<div class="absolute bottom-10 left-[20px] right-[20px] chatbot-input"><div class="relative flex" data-testid="input"><textarea id="realty-ai-chat-input" rows="1" class="focus:outline-none bg-transparent w-full text-input" aria-label="Type your question" role="textbox">`);
...
const TextInput = props => {
  ...
  return (() => {
    ...
    _el$2.$$keydown = submitWhenEnter;
    _el$3.$$input = handleInput;
    const _ref$ = inputRef;
    typeof _ref$ === "function" ? use(_ref$, _el$3) : inputRef = _el$3;
    _el$3.style.setProperty("line-height", "1.5");
    _el$3.style.setProperty("resize", "none");
    _el$3.style.setProperty("padding-top", "12px");
    _el$3.style.setProperty("padding-bottom", "12px");
    _el$3.style.setProperty("padding-left", "16px");
    _el$3.style.setProperty("padding-right", "48px");
    _el$3.style.setProperty("overflow-y", "scroll");
    _el$3.style.setProperty("scrollbar-width", "thin");
    _el$3.style.setProperty("scrollbar-color", "rgba(0, 0, 0, 0.2) transparent");
    _el$3.style.setProperty("box-sizing", "border-box");
    _el$3.style.setProperty("border", "none");
    ...
    createRenderEffect(_p$ => {
      const _v$ = props.backgroundColor ?? defaultBackgroundColor,
        ...
        _v$3 = `${(props.fontSize || 16) * 6 * 1.5 + 24}px`,
        _v$4 = `${(props.fontSize || 16) * 1.5 + 24}px`,
        _v$5 = props.fontSize ? `${props.fontSize}px` : "16px",
        _v$6 = props.placeholder ?? "Type your question";
      ...
      _v$3 !== _p$._v$3 && ((_p$._v$3 = _v$3) != null ? _el$2.style.setProperty("max-height", _v$3) : _el$2.style.removeProperty("max-height"));
      _v$4 !== _p$._v$4 && ((_p$._v$4 = _v$4) != null ? _el$2.style.setProperty("min-height", _v$4) : _el$2.style.removeProperty("min-height"));
      _v$5 !== _p$._v$5 && ((_p$._v$5 = _v$5) != null ? _el$3.style.setProperty("font-size", _v$5) : _el$3.style.removeProperty("font-size"));
      _v$6 !== _p$._v$6 && setAttribute(_el$3, "placeholder", _p$._v$6 = _v$6);
      return _p$;
    }, {
      _v$: undefined,
      _v$2: undefined,
...
const separateTextIntoZeroWidthSpacesParts = (message, maxWordLength = 25, partLength = 5) => {
...
const sanitizeMarkdownHtml = html => {
  ...
  elementsWithEvents.forEach(element => {
    ...
    for (let i = attrs.length - 1; i >= 0; i--) {
      ...
      if (attr.name.startsWith('on') || attr.name === 'javascript:' || attr.name === 'data:' || attr.name === 'vbscript:') {
...
const _tmpl$$8 = /*#__PURE__*/template(`<div class="flex justify-end mb-2 items-end guest-container"><span class="px-4 py-2 mr-2 whitespace-pre-wrap max-w-full chatbot-guest-bubble" data-testid="guest-bubble">`);
...
const _tmpl$$7 = /*#__PURE__*/template(`<div class="flex items-center"><div class="w-2 h-2 mr-1 rounded-full bubble1"></div><div class="w-2 h-2 mr-1 rounded-full bubble2"></div><div class="w-2 h-2 rounded-full bubble3">`);
...
const _tmpl$$4 = /*#__PURE__*/template(`<div class="w-full h-10 flex items-center justify-center text-center">`),
  _tmpl$2$4 = /*#__PURE__*/template(`<span class="leading-4">`),
  _tmpl$3$3 = /*#__PURE__*/template(`<span class="leading-4">Powered by <a href="https://www.realty-ai.com" target="_blank" rel="noopener noreferrer" class="lite-badge" id="lite-badge"><span>Realty AI`);
...
const _tmpl$$2 = /*#__PURE__*/template(`<div class="w-full h-full absolute top-0 left-0 z-[1001]"><div class="w-full h-[64px]"></div><div class="w-full h-full bg-black bg-opacity-30">`),
  _tmpl$2$2 = /*#__PURE__*/template(`<div class="flex flex-col items-start gap-4 absolute right-4 top-[64px] w-[60%] p-4 bg-white rounded-t-none rounded-b-md z-[1002] shadow-lg"><div><div>Notifications</div></div><div><div>Clear Chat</div></div><div><div>Restart Conversation`),
  _tmpl$3$1 = /*#__PURE__*/template(`<button class="border rounded-md p-2 w-8 h-8 flex items-center justify-center" aria-label="Close chat" role="button">&times;`),
  _tmpl$4 = /*#__PURE__*/template(`<div class="question-container flex gap-3 outer-questions">`),
  _tmpl$5 = /*#__PURE__*/template(`<div><div class="w-full h-[64px] flex items-center gap-4 p-4 relative"><h1 class="text-xl flex-1 m-0">Madison</h1><button class="border rounded-md p-2 w-8 h-8 flex items-center justify-center" aria-label="Close chat" role="button">&#x2630;</button></div><div class="flex w-full h-[calc(100%-64px)] justify-center"><div class="overflow-y-scroll min-w-full w-full min-h-full px-3 pt-10 relative scrollable-container chatbot-chat-view scroll-smooth">`),
  _tmpl$6 = /*#__PURE__*/template(`<div class="bg-red-100 text-red-500 text-sm text-center max-w-[60%] mx-auto px-4 py-2 mb-6 mt-6 rounded-md">`),
  _tmpl$7 = /*#__PURE__*/template(`<div class="w-full h-32">`);
...
const Bot = props => {
  ...
  const handleSubmit = async value => {
    try {
      ...
      const newMessages = result.messages.map(message => ({
        ...message,
        loading: message.minimumDisplayTime ? bot_resp_time < message.minimumDisplayTime : false
      }));
      setMessages(prevMessages => [...prevMessages, ...newMessages]);
      newMessages.filter(message => message.loading && !!message.minimumDisplayTime).forEach(message => {
        setTimeout(() => {
          console.log("setting loading to false", message);
          setMessages(prevMessages => prevMessages.map(m => m.timestamp === message.timestamp && m.message === message.message ? {
            ...m,
            loading: false
          } : m));
          scrollToBottom();
  ...
  return (() => {
    ...
    _el$5.$$click = () => setMenuOpen(!menuOpen());
    insert(_el$3, createComponent(Show, {
      get when() {
        return menuOpen();
      },
    ...
    insert(_el$3, createComponent(Show, {
      ...
      get children() {
        ...
        addEventListener(_el$7, "click", props.closeBoxFunction, true);
        createRenderEffect(_p$ => {
          const _v$ = props.headerTextColor || "#ffffff",
            _v$2 = props.headerTextColor || "#ffffff";
          _v$ !== _p$._v$ && ((_p$._v$ = _v$) != null ? _el$7.style.setProperty("color", _v$) : _el$7.style.removeProperty("color"));
          _v$2 !== _p$._v$2 && ((_p$._v$2 = _v$2) != null ? _el$7.style.setProperty("border-color", _v$2) : _el$7.style.removeProperty("border-color"));
          return _p$;
        }, {
          _v$: undefined,
          _v$2: undefined
    ...
    typeof _ref$2 === "function" ? use(_ref$2, _el$9) : chatContainer = _el$9;
    insert(_el$9, createComponent(For, {
      get each() {
        return [...messages()];
      },
      children: (message, index) => [createMemo((() => {
        const _c$2 = createMemo(() => message.type === MessageType.UserMessage);
        ...
        const _c$3 = createMemo(() => message.type === MessageType.BotMessage);
        return () => _c$3() && createComponent(BotBubble, {
          ...
          get hidden() {
            return createMemo(() => !!message.loading)() && messages().findLastIndex(m => m.loading) !== index();
          },
          get loading() {
        ...
        const _c$4 = createMemo(() => message.type === MessageType.ErrorMessage);
        return () => _c$4() && (() => {
          const _el$11 = _tmpl$6();
          insert(_el$11, () => message.message);
          return _el$11;
        })();
      })())]
    }), null);
    insert(_el$9, (() => {
      const _c$ = createMemo(() => !!loading());
      return () => _c$() && createComponent(BotBubble, {
        message: "",
        get backgroundColor() {
          return props.botMessage?.backgroundColor;
        },
    ...
    insert(_el$8, createComponent(Show, {
      get when() {
        return createMemo(() => !!(props.includeQuestions && !questionClicked()))() && !userInput();
      },
      get children() {
        const _el$10 = _tmpl$4();
        _el$10.style.setProperty("position", "absolute");
        _el$10.style.setProperty("left", "20px");
        _el$10.style.setProperty("width", "calc(100% - 40px)");
        _el$10.style.setProperty("bottom", "100px");
        _el$10.style.setProperty("margin", "auto");
        _el$10.style.setProperty("z-index", "1000");
        insert(_el$10, () => props.questions?.map((item, index) => createComponent(QuestionButton, {
          question: item,
    ...
    insert(_el$8, createComponent(TextInput, {
      get backgroundColor() {
    ...
    createRenderEffect(_p$ => {
      const _v$3 = "relative flex w-full h-full text-base overflow-hidden bg-cover bg-center flex-col items-center chatbot-container " + props.class,
        _v$4 = props.headerColor || "#3B81F6",
        _v$5 = props.headerTextColor || "#ffffff",
        _v$6 = props.headerTextColor || "#ffffff",
        _v$7 = props.headerTextColor || "#ffffff",
        _v$8 = props.includeQuestions && !questionClicked() ? "170px" : "110px";
      _v$3 !== _p$._v$3 && className(_el$, _p$._v$3 = _v$3);
      ...
      _v$7 !== _p$._v$7 && ((_p$._v$7 = _v$7) != null ? _el$5.style.setProperty("border-color", _v$7) : _el$5.style.removeProperty("border-color"));
      _v$8 !== _p$._v$8 && ((_p$._v$8 = _v$8) != null ? _el$9.style.setProperty("padding-bottom", _v$8) : _el$9.style.removeProperty("padding-bottom"));
      return _p$;
    }, {
      _v$3: undefined,
      _v$4: undefined,
...
const BottomSpacer = props => {
  return (() => {
    ...
    typeof _ref$4 === "function" ? use(_ref$4, _el$12) : props.ref = _el$12;
    return _el$12;
  })();
};
delegateEvents(["click"]);
  ...
  return createComponent(Show, {
    ...
    get children() {
      return [(() => {
        ...
        get position() {
          return bubbleProps.theme?.button?.position || "right";
        },
        get showAvatar() {
        ...
        insert(_el$3, createComponent(Show, {
          ...
          get children() {
            return createComponent(Bot, {
              ...
              get headerColor() {
                return bubbleProps.theme?.button?.backgroundColor;
              },
              get headerTextColor() {
                return bubbleProps.theme?.button?.iconColor;
              },
              get textInput() {
        ...
        createRenderEffect(_p$ => {
          const _v$ = bubbleProps.theme?.chatWindow?.height ? `${bubbleProps.theme?.chatWindow?.height.toString()}px` : height_calc,
            ...
            _v$4 = `fixed rounded-lg w-full sm:w-[400px] max-h-[704px] overflow-hidden` + (isBotOpened() ? " opacity-1" : " opacity-0 pointer-events-none") + (props.theme?.button?.size === "large" ? " bottom-28" : " bottom-24") + (props.theme?.button?.position === "right" ? " sm:right-5" : " sm:left-5");
