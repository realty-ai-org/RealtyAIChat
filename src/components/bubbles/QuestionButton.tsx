...
export const QuestionButton = (props: Props) => {
  ...
  return (
    <div class={"flex"} data-testid="input">
      <Show when={isMobile}>
        <button
          class={"justify-between question-button-mobile"}
          style={{ "font-size": props.mobileQuestionFontSize }}
          onClick={() => {
      ...
      <Show when={!isMobile}>
        <button
          class={"justify-between question-button-desktop"}
          style={{ "font-size": props.desktopQuestionFontSize }}
          onClick={() => {
            props.onQuestionClick(props.question);
          }}
        >
